...
import com.xh.ucenter.util.ConstantPropertiesUtil;
import com.xh.ucenter.util.HttpClientUtils;
...
//        CookieUtils.setCookie(request, response, "guli_jwt_token", token);
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "yaher";//为了让大家能够使用我搭建的外网的微信回调跳转服务器，这里填写你在ngrok的前置域名
